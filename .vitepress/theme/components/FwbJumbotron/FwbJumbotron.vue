...
const wrapperClasses = computed(() => twMerge(
  'py-8 lg:py-16 px-4 mx-auto max-w-screen-xl text-center ',
  attrs.class as string))

const headerClassesComputed = computed(() => twMerge('name clip mb-4 text-4xl font-extrabold tracking-tight leading-none text-gray-900 md:text-5xl lg:text-6xl dark:text-white', props.headerClasses))
